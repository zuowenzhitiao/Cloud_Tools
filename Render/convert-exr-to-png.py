...
def parse_command_line_arguments(arguments=None):
    ...
    parser.add_argument('--input_image', dest='', action='store', help=arg_help)
    ...
    parser.add_argument('--input-directory', dest='input_directory', default = os.getcwd(),
                        action='store', help=arg_help)
...
# 更改保存路径
    args = parse_command_line_arguments()
    args.input_directory = '/media/ubuntu/JK的1号仓库/wcc实验/点云对照/mse'
    args.output_directory = '/media/ubuntu/JK的1号仓库/wcc实验/点云对照/mse'
